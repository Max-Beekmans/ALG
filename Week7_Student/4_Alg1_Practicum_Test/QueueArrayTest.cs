...
namespace Alg1_Practicum_Test
{
    ...
    public class NawQueueArrayTest : ContextBoundObject
    {
        ...
        public void QueueArray_EnqueueDequeueTenItems_ShouldWrapAround()
        {
            // first add 2 items
            queue.Enqueue(naw0);
            queue.Enqueue(naw1);
        ...
        [TestCategory("WS7 - Queue - Array")]
        [TestSummary(@"We maken een lege NawQueueArray aan. Count() zou 0 moeten zijn")]
        public void QueueArray_Count_Empty_ShouldReturn0()
        {
