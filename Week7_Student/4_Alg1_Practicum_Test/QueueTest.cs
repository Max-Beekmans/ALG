...
namespace Alg1_Practicum_Test
{
    ...
    public class QueueTest : ContextBoundObject
    {
        ...
        [PrintCode("Queue", "Count")]
        [TestCategory("WS7 - Queue - Linked List")]
        [TestSummary(@"We maken een lege Queue aan. Count() zou 0 moeten zijn")]
        public void Queue_Count_Empty_ShouldReturn0()
        {
